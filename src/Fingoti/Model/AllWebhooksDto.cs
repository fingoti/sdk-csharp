...
namespace Fingoti.Model
{
    ...
    /// AllWebhooksDto
    /// </summary>
    [DataContract(Name = "AllWebhooksDto")]
    public partial class AllWebhooksDto : IEquatable<AllWebhooksDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllWebhooksDto" /> class.
        /// </summary>
        ...
        public AllWebhooksDto(Guid id = default(Guid), Guid organisationId = default(Guid), bool disabled = default(bool), string webhookNumber = default(string), Guid createdBy = default(Guid), DateTime createdOn = default(DateTime), int triggers = default(int), List<string> properties = default(List<string>), string webhookUrl = default(string), List<WebhookHeaders> webhookHeaders = default(List<WebhookHeaders>), List<string> devices = default(List<string>), DateTime? lastCall = default(DateTime?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllWebhooksDto {\n");
        ...
        {
            return this.Equals(input as AllWebhooksDto);
        }

        /// <summary>
        /// Returns true if AllWebhooksDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AllWebhooksDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllWebhooksDto input)
        {
            if (input == null)
            {
                return false;
