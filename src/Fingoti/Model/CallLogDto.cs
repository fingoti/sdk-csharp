...
namespace Fingoti.Model
{
    ...
    /// CallLogDto
    /// </summary>
    [DataContract(Name = "CallLogDto")]
    public partial class CallLogDto : IEquatable<CallLogDto>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallLogDto" /> class.
        /// </summary>
        ...
        public CallLogDto(Guid id = default(Guid), Guid webhookId = default(Guid), string webhookNumber = default(string), WebhookStatus? status = default(WebhookStatus?), DateTime? timestamp = default(DateTime?), string requestUrl = default(string), List<WebhookHeaders> requestHeaders = default(List<WebhookHeaders>), Object requestBody = default(Object), List<WebhookAttempts> attempts = default(List<WebhookAttempts>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as CallLogDto);
        }

        /// <summary>
        /// Returns true if CallLogDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CallLogDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallLogDto input)
        {
            if (input == null)
            {
                return false;
