...
namespace Fingoti.Model
{
    ...
    /// PartnerAddress
    /// </summary>
    [DataContract(Name = "PartnerAddress")]
    public partial class PartnerAddress : IEquatable<PartnerAddress>, IValidatableObject
    {
        ...
        public PartnerAddress(string line1 = default(string), string line2 = default(string), string city = default(string), string county = default(string), string postcode = default(string), string country = default(string))
        {
            this.Line1 = line1;
            this.Line2 = line2;
            this.City = city;
