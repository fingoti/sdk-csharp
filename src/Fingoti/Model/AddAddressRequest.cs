...
namespace Fingoti.Model
{
    ...
    /// AddAddressRequest
    /// </summary>
    [DataContract(Name = "AddAddressRequest")]
    public partial class AddAddressRequest : IEquatable<AddAddressRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddAddressRequest" /> class.
        /// </summary>
        ...
        public AddAddressRequest(string line1 = default(string), string line2 = default(string), string city = default(string), string county = default(string), string postcode = default(string), string country = default(string))
        {
            // to ensure "line1" is required (not null)
            if (line1 == null)
            {
                throw new ArgumentNullException("line1 is a required property for AddAddressRequest and cannot be null");
            }
            this.Line1 = line1;
            // to ensure "postcode" is required (not null)
            if (postcode == null)
            {
                throw new ArgumentNullException("postcode is a required property for AddAddressRequest and cannot be null");
            }
            this.Postcode = postcode;
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for AddAddressRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as AddAddressRequest);
        }

        /// <summary>
        /// Returns true if AddAddressRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddAddressRequest input)
        {
            if (input == null)
            {
                return false;
