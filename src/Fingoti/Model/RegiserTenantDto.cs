...
namespace Fingoti.Model
{
    ...
    /// RegiserTenantDto
    /// </summary>
    [DataContract(Name = "RegiserTenantDto")]
    public partial class RegiserTenantDto : IEquatable<RegiserTenantDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegiserTenantDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RegiserTenantDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RegiserTenantDto" /> class.
        /// </summary>
        ...
        /// <param name="customerForename">customerForename.</param>
        /// <param name="customerSurname">customerSurname.</param>
        public RegiserTenantDto(string organisationName = default(string), string organisationHandle = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string city = default(string), string county = default(string), string postcode = default(string), string country = default(string), string vatNumber = default(string), bool isBusiness = default(bool), Guid partnerId = default(Guid), string customerEmail = default(string), string customerForename = default(string), string customerSurname = default(string))
        {
            // to ensure "organisationName" is required (not null)
            if (organisationName == null)
            {
                throw new ArgumentNullException("organisationName is a required property for RegiserTenantDto and cannot be null");
            }
            this.OrganisationName = organisationName;
            // to ensure "organisationHandle" is required (not null)
            if (organisationHandle == null)
            {
                throw new ArgumentNullException("organisationHandle is a required property for RegiserTenantDto and cannot be null");
            }
            this.OrganisationHandle = organisationHandle;
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for RegiserTenantDto and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "postcode" is required (not null)
            if (postcode == null)
            {
                throw new ArgumentNullException("postcode is a required property for RegiserTenantDto and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets CustomerForename
        /// </summary>
        [DataMember(Name = "customerForename", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegiserTenantDto {\n");
        ...
        {
            return this.Equals(input as RegiserTenantDto);
        }

        /// <summary>
        /// Returns true if RegiserTenantDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RegiserTenantDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegiserTenantDto input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CustomerForename == input.CustomerForename ||
                    (this.CustomerForename != null &&
                    this.CustomerForename.Equals(input.CustomerForename))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.CustomerForename.GetHashCode();
                }
